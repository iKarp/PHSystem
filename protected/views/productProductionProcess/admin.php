...
$this->menu=array(
	...
	array('label'=>'Create ProductProductionProcess', 'url'=>array('create'), 'linkOptions'=>array(
		'ajax' => array(
...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('product-production-process-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
<h1>Manage Product Production Processes</h1>
...
<?php $this->widget('bootstrap.widgets.TbGridView',array(
	'id'=>'product-production-process-grid',
	'ajaxUpdate'=>false,
