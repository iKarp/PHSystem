...
$this->menu=array(
	...
	array('label'=>'Create ProductionProcessMaterial', 'url'=>array('create'), 'linkOptions'=>array(
		'ajax' => array(
...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('production-process-material-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
<h1>Manage Production Process Materials</h1>
...
<?php $this->widget('bootstrap.widgets.TbGridView',array(
	'id'=>'production-process-material-grid',
	'ajaxUpdate'=>false,
