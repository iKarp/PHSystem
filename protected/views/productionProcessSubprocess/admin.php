...
$this->menu=array(
	...
	array('label'=>'Create ProductionProcessSubprocess', 'url'=>array('create'), 'linkOptions'=>array(
		'ajax' => array(
...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('production-process-subprocess-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
<h1>Manage Production Process Subprocesses</h1>
...
<?php $this->widget('bootstrap.widgets.TbGridView',array(
	'id'=>'production-process-subprocess-grid',
	'ajaxUpdate'=>false,
