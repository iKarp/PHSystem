...
$this->menu=array(
	...
	array('label'=>'Create ProductionOperationMeasurement', 'url'=>array('create'), 'linkOptions'=>array(
		'ajax' => array(
...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('production-operation-measurement-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
<h1>Manage Production Operation Measurements</h1>
...
<?php $this->widget('bootstrap.widgets.TbGridView',array(
	'id'=>'production-operation-measurement-grid',
	'ajaxUpdate'=>false,
