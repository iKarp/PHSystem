...
$this->menu=array(
	...
	array('label'=>'Create ProductSemiproduct', 'url'=>array('create'), 'linkOptions'=>array(
		'ajax' => array(
...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('product-semiproduct-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
<h1>Manage Product Semiproducts</h1>
