...
class OrderProductController extends Controller
{
	...
	public function actionCreate()
	{
        ...
        if(isset($_GET['order_id'])) $model->order_id = $_GET['order_id'];
		...
		if(isset($_POST['OrderProduct']))
		{
			...
			if($model->save())
				$this->redirect(array('order/update','id'=>$model->order_id));
		}
	...
	public function actionUpdate($id)
	{
		...
		//$model->calculate();
        $processes = new CArrayDataProvider($model->product->processes);
