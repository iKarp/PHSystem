...
class ProductController extends Controller
{
	...
	public function actionAutoCompleteLookup()
	{
        if(Yii::app()->request->isAjaxRequest && isset($_GET['q']))
       {
          ...
          $criteria->condition = "is_folder=0 AND is_active=1 AND `name` LIKE :sterm";
          ...
          {
             $returnVal .= $data->getAttribute('name').'|'.$data->getAttribute('id').'|'.$data->getAttribute('fcost').'|'.$data->getAttribute('vcost')."\n";
          }
          echo $returnVal;
       }
    }
