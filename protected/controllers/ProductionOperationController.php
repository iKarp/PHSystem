...
class ProductionOperationController extends Controller
{
	...
	{
		$model=new ProductionOperation('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['ProductionOperation']))
			$model->attributes=$_GET['ProductionOperation'];
	...
	{
		$model=ProductionOperation::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='production-operation-form')
		{
